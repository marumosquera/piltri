  ...
  return (
    <div className='know-page'>
      ...
      <div className='w-1/3'>
        ...
        <p className='text-slate-400 mail'>diego.cazap@piltri.io</p>
      </div>
      <div className='w-1/3'>
        <img src="./assets/maru.jpeg" alt="" className='img-us'/>
        <p>Elisa Mosquera</p>
        <p className='text-slate-700'>Co-founder</p>
        <p className='text-slate-400 mail'>elisa.mosquera@piltri.io</p>
      </div>
      <div className='w-1/3'>
        <img src="./assets/juli.jpeg" alt="" className='img-us'/>
        <p>Julian Lavagna</p>
        <p className='text-slate-700'>Co-founder</p>
        <p className='text-slate-400 mail'>julian.lavagna@piltri.io</p>
      </div>
      </div>
